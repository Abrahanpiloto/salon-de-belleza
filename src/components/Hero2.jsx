...
const Hero2 = () => {
  return (
    <section
      className="min-h-screen relative w-full h-[90vh] bg-cover bg-center bg-no-repeat overflow-hidden"
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="w-48 h-48 lg:w-64 lg:h-64">
                <img
                  src="/1.png"
                  alt="Logo del salón"
                  className="w-full h-full object-contain drop-shadow-2xl rounded-full opacity-80"
                />
              </div>

              {/* BOTÓN DEBAJO DEL LOGO (solo en desktop) */}
              <button className="px-10 py-2 bg-white text-black font-bold text-lg rounded-md hover:bg-amber-200 transition shadow-lg">
                Agenda aquí
              </button>
            </div>
          </div>
