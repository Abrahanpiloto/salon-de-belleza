...
const InfoWhy = () => {
  return (
    <div className="grid grid-cols-4 grid-rows-1 gap-0">
      <div className="bg-gray-900 text-white px-8 h-86 flex flex-col items-start justify-center">
      ...
      <div className="bg-green-300 px-8 flex flex-col items-start justify-center gap-2">
        <h1>
          {" "}
      ...
      <div className="bg-rose-400 flex flex-col items-start px-8 justify-center gap-2">
        <h1>
          {" "}
          <span className="font-light text-2xl">
      ...
      <div className="bg-amber-200 flex flex-col items-start px-8 justify-center gap-2">
        <h1>
          {" "}
          <span className="font-light text-2xl">
